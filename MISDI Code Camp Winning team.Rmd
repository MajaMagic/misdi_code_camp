---
title: "MISDI Code Camp Winning team"
author: "MajaMagic"
date: "2023-06-22"
...
```{r}
# create a dataset (with B)
imdb_rmna <- imdb_bechdel %>% 
  filter(!is.na(rating)) %>% 
imdb_rmna %>% select(rating)
 
# Grouped
ggplot(imdb_rmna, aes(fill=condition, y=value, x=specie)) + 
